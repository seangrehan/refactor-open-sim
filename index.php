...
<body class="opensimbody">
	<div class="opensimcontainer">
		...
		&nbsp;
			...
			<div class="content">
				<h1 class="opensimh1">Sean Grehan's Demosite</h1>
    			<p class="opensimp">OpenSim is an open source multi-platform, multi-user 3D application server. It can be used to create a virtual environment (or world) which can be accessed through a variety of clients, on multiple protocols.</p>
     		</div>
   		</div>
		<div class="footer">
