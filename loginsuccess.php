...
<body class="opensimbody">
	<div class="opensimcontainer">
		...
		&nbsp;
			...
			<div class="content">
				<h1 class="opensimh1">Login Successful</h1>
				<p class="opensimp">This is the registered users homepage where you can enter your content</p>
				<p class="opensimp">It might be a good idea to have a link to a <a href="logout.php">logout.php</a> page here</p>
     		</div>
   		</div>
		<div class="footer">
...
[clive@cd session_new]$ cat login_success.php
</html>
